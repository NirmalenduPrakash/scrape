...
class ScrapeUtil(scrapy.Spider):
    ...
    def __init__(self, dataFile):
        ...
        self.urls = [x.strip() for x in open('paths.txt', "r").readlines()]

    def parse(self, response):
        TITLE_PATH='//title/text()'
        XPATH_Overview= '//div[contains(@id,"overview")]'
        XPATH_Lecturer = '//div[contains(@id,"instructors")]/div[contains(@class,"row")]/div[2]/h3/text()'
